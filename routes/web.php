...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/characters', [CharacterController::class, 'index'])->name('character.home');
    Route::get('/characters/create', [CharacterController::class, 'create'])->name('character.create');
    Route::post('/characters/create', [CharacterController::class, 'store'])->name('character.store');
